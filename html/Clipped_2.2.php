...
?>
		...
		<div id="negative" data-role="fieldcontain">
...
<?php
	...
	echo '<input id="negative1" name="negative" value="0" data-theme="" type="radio"' . $s1 . '><label for="negative1">White on Black</label>';
	echo '<input id="negative2" name="negative" value="1" data-theme="" type="radio"' . $s2 . '><label for="negative2">Black on White</label>';
?>
			</fieldset>
		</div>
